class BlogPostsController < ApplicationController
  ...
  def create
  	...
  	respond_to do |format|
  		if @blog_post.save #Method from the BlogPost class
  			format.html { redirect_to blog_post_url(@blog_post), notice: "Blog Post was created successfully."} #route when BlogPost successfully saved to database
  		else
